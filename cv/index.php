...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css">	<link rel="stylesheet" href="main.css">
...
<body class="p-3">
    <nav class="navbar sticky-top bg-body-tertiary biru">
        <div class="container-fluid">
            ...
            <a class="btn btn-outline-secondary" href="admin.php">Update</a>
        </div>
    </nav>
    <div class="p-3">
        <div class="card">
